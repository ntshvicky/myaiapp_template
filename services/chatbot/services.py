...
class ChatbotService:
    ...
    def __init__(self):
        self.system_prompt = (
            ...
            "For Mermaid, use flowchart syntax with one statement per line, quote every label, avoid commas "
            "inside node IDs, and use this pattern: flowchart LR; subgraph Human[\"Human Intelligence\"]; "
            "H1[\"Sensory input\"] --> H2[\"Reasoning\"]; end. Never put Mermaid as a single long paragraph."
        )
